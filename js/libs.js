...
(function(e) {
    if (!Function.prototype.bind)
        Function.prototype.bind = function(d) {
            var a = [].slice, b = a.call(arguments, 1), c = this, g = function() {}, f = function() {
    ...
    e.Code.Util = {
        ...
        extend: function(d, a, b) {
            ...
            if (d && a && this.isObject(a))
                for (c in a)
                    this.objectHasProperty(a, c) && (b ? d[c] = a[c] : typeof d[c] === "undefined" && (d[c] = a[c]))
        },
        clone: function(d) {
            var a = {};
            this.extend(a, d);
        ...
        DOM: {
            setData: function(b, c, g) {
                if (a.isLikeArray(b)) {
                    ...
                    for (d = b.length; f < d; f++)
                        a.DOM._setData(b[f], c, g)
                } else 
                    a.DOM._setData(b, c, g)
            },
            ...
            removeData: function(b, c) {
                if (a.isLikeArray(b)) {
                    ...
                    for (f = b.length; g < f; g++)
                        a.DOM._removeData(b[g], c)
                } else 
                    a.DOM._removeData(b, c)
            },
            ...
            setAttribute: function(b, c, g) {
                if (a.isLikeArray(b)) {
                    ...
                    f = 0;
                    for (d = b.length; f < d; f++)
                        a.DOM._setAttribute(b[f], c, g)
                } else 
                    a.DOM._setAttribute(b, c, g)
            },
            ...
            removeAttribute: function(b, c) {
                if (a.isLikeArray(b)) {
                    ...
                    g = 0;
                    for (f = b.length; g < f; g++)
                        a.DOM._removeAttribute(b[g], c)
                } else 
                    a.DOM._removeAttribute(b, c)
            },
            ...
            removeClass: function(b, c) {
                if (a.isLikeArray(b)) {
                    ...
                    g = 0;
                    for (f = b.length; g < f; g++)
                        a.DOM._removeClass(b[g], c)
                } else 
                    a.DOM._removeClass(b, c)
            },
            ...
            setStyle: function(b, c, g) {
                if (a.isLikeArray(b)) {
                    ...
                    a.DOM._setStyle(b, c, g)
            },
            _setStyle: function(b, c, g) {
                var f;
                if (a.isObject(c))
                    for (f in c)
                        a.objectHasProperty(c, f) && (f === "width" ? a.DOM.width(b, c[f]) : f === "height" ? a.DOM.height(b, c[f]) : d(b).css(f, c[f]));
                else 
                    d(b).css(c, g)
            },
            ...
            windowScrollLeft: function() {
                if (!e.pageXOffset)
                    return d(e).scrollLeft();
                return e.pageXOffset
            },
            windowScrollTop: function() {
                if (!e.pageYOffset)
                    return d(e).scrollTop();
        ...
        Animation: {
            ...
            stop: function(a) {
                if (d.Browser.isCSSTransformSupported) {
                    ...
                    d.isNothing(e.jQuery) || e.jQuery(a).stop(!0, !0)
            },
            ...
            _leaveTransforms: function(a) {
                var b = a.style[this._transitionPrefix + "Property"], c = b !== "" ? "ccl" + b + "callback": "cclallcallback", g, b = d.coalesce(a.style.webkitTransform, a.style.MozTransform, a.style.transform), f, i = e.parseInt(d.DOM.getStyle(a, "left"), 0), j = e.parseInt(d.DOM.getStyle(a, "top"), 0), h, l, k = {};
                ...
                e.setTimeout(function() {
                    if (!d.isNothing(f))
                        k = {}, k[this._transformLabel] = "", k.left = i + h + "px", k.top = j + l + "px", d.DOM.setStyle(a, k);
    ...
    a.TouchElement.TouchElementClass = d({
        ...
        addEventHandlers: function() {
            if (a.isNothing(this.touchStartHandler))
                this.touchStartHandler = this.onTouchStart.bind(this), this.touchMoveHandler =
        ...
        fireTouchEvent: function(b) {
            var c = 0, g = 0, f = 0, d, c = this.touchEndPoint.x - this.touchStartPoint.x, g = this.touchEndPoint.y - this.touchStartPoint.y, f = Math.sqrt(c * c + g * g);
...
(function(e, d, a) {
    ...
    b.Image.ImageClass = d({
        ...
        dispose: function() {
            ...
            this.shrinkImage();
            for (c in this)
                a.objectHasProperty(this, c) && (this[c] = null)
        },
    ...
    b.Cache.CacheClass = d({
        ...
        dispose: function() {
            ...
            if (!a.isNothing(this.images)) {
                b = 0;
                for (f = this.images.length; b < f; b++)
                    this.images[b].dispose();
        ...
        initialize: function(a, g) {
            ...
            for (d = a.length; f < d; f++)
                e = a[f], h = this.settings.getImageSource(e), l = this.settings.getImageCaption(e),
        ...
        getImages: function(c) {
            ...
            if (this.settings.cacheMode === b.Cache.Mode.aggressive) {
                ...
                for (f = this.images.length; g < f; g++)
                    e = this.images[g], a.objectHasProperty(e, "cacheDoNotShrink") ? delete e.cacheDoNotShrink : e.shrinkImage()
            }
            return d
        }
    })
    ...
    b.DocumentOverlay.DocumentOverlayClass = d({
        ...
        resetPosition: function() {
            ...
            if (this.settings.target === e) {
                ...
                if (b < 1)
                    b = this.initialBodyHeight;
                a.DOM.windowHeight() > b &&
                (b = a.DOM.windowHeight())
            } else 
                c = a.DOM.width(this.settings.target), b = a.DOM.height(this.settings.target), f = "0px";
            a.DOM.setStyle(this.el, {
                width: c,
                height: b,
                top: f
    ...
    b.Carousel.CarouselClass = d({
        ...
        dispose: function() {
            ...
            for (f = this.cache.images.length; g < f; g++)
                a.Events.remove(this.cache.images[g], b.Image.EventTypes.onLoad,
        ...
        show: function(c) {
            ...
            for (f = c.length; d < f; d++)
                a.Animation.resetTranslate(c[d]);
            a.Events.fire(this, {
            ...
            if (!this.isSliding) {
                ...
                if (!(e.Math.abs(j) < 1)) {
                    ...
                    if (!this.settings.loop && (this.lastSlideByAction === b.Carousel.SlideByAction.previous && this.currentCacheIndex === 0 || this.lastSlideByAction === b.Carousel.SlideByAction.next && this.currentCacheIndex === this.cache.images.length-1))
                        c = 0, this.lastSlideByAction = b.Carousel.SlideByAction.current;
                    this.isSliding=!0;
        ...
        stopSlideshow: function() {
            if (!a.isNothing(this.slideshowTimeout))
                e.clearTimeout(this.slideshowTimeout), this.slideshowTimeout = null, this.isSlideshowActive=!1, a.Events.fire(this, {
        ...
        onSlideByEnd: function() {
            if (!a.isNothing(this.isSliding)) {
                ...
                if (this.settings.loop)
                    if (this.lastSlideByAction === b.Carousel.SlideByAction.next ? a.DOM.appendChild(c[0], this.contentEl) : this.lastSlideByAction === b.Carousel.SlideByAction.previous && a.DOM.insertBefore(c[c.length-1], c[0], this.contentEl), this.currentCacheIndex < 0)
    ...
    d.Carousel.CarouselClass = d.Carousel.CarouselClass.extend({
        ...
        doSlideCarousel: function(b, c) {
            ...
            if (c <= 0)
                ...
                d = a.coalesce(this.contentEl.style.webkitTransform,
...
(function(e, d, a) {
    ...
    b.Toolbar.ToolbarClass = d({
        ...
        handleTap: function(c) {
            ...
            else if (c.target === this.previousEl || a.DOM.isChildOf(c.target, this.previousEl))
                d = b.Toolbar.ToolbarAction.previous;
            else if (c.target === this.closeEl || a.DOM.isChildOf(c.target, this.closeEl))
            ...
            this.setTimeout();
            if (a.isNothing(d))
                d = b.Toolbar.ToolbarAction.none;
            a.Events.fire(this, {
    ...
    b.ZoomPanRotate.ZoomPanRotateClass = d({
        ...
        initialize: function(c, d, f) {
            ...
            a.Browser.iOS ? (this.containerEl = a.DOM.createElement("div", "", ""), a.DOM.setStyle(this.containerEl, {
                left : 0, top : 0, width : i, height : j, position : "absolute", zIndex : 1
        ...
        applyTransform: function() {
            ...
            f = e.parseInt(this.transformSettings.translateY, 10), i = "scale(" + this.transformSettings.scale + ") rotate(" + c + "deg) translate(" + d + "px, " + f + "px)";
...
(function(e, d) {
    ...
    a.detatch = function(b) {
        ...
        for (e = b.originalImages.length; c < e; c++)
            f = b.originalImages[c], !d.isNothing(f.nodeType) && f.nodeType === 1 && (d.Events.remove(f, "click", f.__photoSwipeClickHandler),
    ...
    a.createInstance = function(b, c, e) {
        ...
        if (d.isNothing(f))
            ...
            throw 'Code.PhotoSwipe.createInstance: Instance with id "' +
            e + ' already exists."';
        return f
    };
...
(function(e, d, a, b, c, g, f, i, j) {
    ...
    h.PhotoSwipeClass = d({
        ...
        d, f) {
            ...
            if (a.Browser.android&&!a.Browser.firefox && e.navigator.userAgent.match(/Android (\d+.\d+)/).toString().replace(/^.*\,/, "") >= 2.1)
        ...
        resetPosition: function() {
            if (!this._isResettingPosition) {
                ...
                if (a.isNothing(this.windowDimensions) ||!(b.width === this.windowDimensions.width && b.height === this.windowDimensions.height))
                    this._isResettingPosition=!0, this.windowDimensions = b, this.destroyZoomPanRotate(), this.documentOverlay.resetPosition(), this.carousel.resetPosition(), a.isNothing(this.toolbar) || this.toolbar.resetPosition(), this.uiLayer.resetPosition(), this._isResettingPosition=!1, a.Events.fire(this, {
        ...
        createZoomPanRotate: function() {
            ...
            if (this.canUserZoom()&&!this.isZoomActive())
                a.Events.fire(this, h.EventTypes.onBeforeZoomPanRotateShow), this.zoomPanRotate = new j.ZoomPanRotateClass(this.settings,
        ...
        destroyZoomPanRotate: function() {
            if (!a.isNothing(this.zoomPanRotate))
                a.Events.fire(this, h.EventTypes.onBeforeZoomPanRotateHide), a.Events.remove(this.zoomPanRotate,
        ...
        setUIWebViewResetPositionTimeout: function() {
            if (this.settings.enableUIWebViewRepositionTimeout && a.Browser.iOS&&!a.Browser.safari)
                a.isNothing(this._uiWebViewResetPositionTimeout) || e.clearTimeout(this._uiWebViewResetPositionTimeout), this._uiWebViewResetPositionTimeout =
            e.setTimeout(function() {
                this.resetPosition();
                this.setUIWebViewResetPositionTimeout()
    ...
    d.flexslider = function(i, k) {
            ...
            touch: function() {
                function b(b) {
                    ...
                    if (!p || 500 < Number(new Date) - k)
                        b.preventDefault(), !r && a.transitions && (c.animationLoop || (j/=0 === a.currentSlide && 0 > j || a.currentSlide === a.last && 0 < j ? Math.abs(j) / q + 2 : 1), a.setProps(f + j, "setTouch"))
                }
                function g() {
        ...
        a.flexAnimate = function(b, g, n, i, k) {
            ...
            if (!a.animating && (a.canAdvance(b, k) || n) && a.is(":visible")) {
                if (s && i)
                    if (n = d(c.asNavFor).data("flexslider"), a.atEnd = 0 === b || b === a.count-1, n.flexAnimate(b, !0, !1, !0, k)
                        , a.direction = a.currentItem < b ? "next" : "prev", n.direction = a.direction, Math.ceil((b + 1) / a.visible)-1 !== a.currentSlide && 0 !== b)a.currentItem = b, a.slides.removeClass(e + "active-slide").eq(b).addClass(e +
                ...
                if (r)
                    ...
                    h ? (b = c.itemWidth > a.w ? 2 * c.itemMargin : c.itemMargin, b = (a.itemW + b) * a.move * a.animatingTo, b = b > a.limit && 1 !== a.visible ? a.limit : b) : b = 0 === a.currentSlide && b === a.count-1 && c.animationLoop && "next" !== a.direction ? m ? (a.count + a.cloneOffset) *
                    q : 0 : a.currentSlide === a.last && 0 === b && c.animationLoop && "prev" !== a.direction ? m ? 0 : (a.count + 1) * q : m ? (a.count-1 - b + a.cloneOffset) * q : (b + a.cloneOffset) * q;
                ...
                c.smoothHeight &&
                f.smoothHeight(c.animationSpeed)
            }
        };
        a.wrapup = function(b) {
        ...
        a.canAdvance = function(b, g) {
            ...
            return g?!0 : s && a.currentItem === a.count-1 && 0 === b && "prev" === a.direction?!0 : s && 0 === a.currentItem && b === a.pagingCount-1 && "next" !== a.direction?!1 : b === a.currentSlide&&!s?!1 : c.animationLoop?!0 : a.atEnd && 0 === a.currentSlide && b === d && "next" !== a.direction?!1 : a.atEnd && a.currentSlide === d && 0 ===
...
/*
 * ios: avoid elastic bounces when not necessary. would neeed a major rebuild.
 */

if ($.browser.safari == true) {
    document.getElementById("contentWrapper").addEventListener('touchstart', function(event){
    ...
    document.getElementById("contentWrapper").addEventListener('touchmove', function(event){
...
/*
 * ios7 custom styles for status bar
 */
...
function sendMail() {
  window.plugin.email.open({
      to:          ["vittorio@vittorioorlandi.com"], // contains all the email addresses for TO field
      subject:    "Richiesta da App", // represents the subject of the email
      body:       "Caro Vittorio,<br />", // represents the email body (could be HTML code, in this case set isHtml to true)
